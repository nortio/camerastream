...
class ImageUtils {
  ...
  static imglib.Image convertYUV420ToImage(CameraImage cameraImage) {
    ...
    //log(
    //  "Image size: ${cameraImage.width}x${cameraImage.height}, Format: ${cameraImage.format.group} - ${cameraImage.format.raw}, UVRowStride: ${uvRowStride}, UVPixelStride: ${uvPixelStride}",
    //);
